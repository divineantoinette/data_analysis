...
--Right click, tasks, and import flat file and follow the steps
--Data aggregation using functions SUM(), AVG(), COUNT(), MAX(), MIN()
--Data summarisation using GROUP BY clause
